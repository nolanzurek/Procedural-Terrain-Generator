...
void setup () {
  ...
  deadBush = loadImage("deadBush.png");
  flowerPink = loadImage("flowerPink.png");
  flowerRed = loadImage("flowerRed.png");
  flowerYellow = loadImage("flowerYellow.png");
  notSnowyTree = loadImage("notSnowyTreeExport.png");
  notSnowyTreeTwoHumps = loadImage("shortSnowyTreeTwoHumpsExport.png");
  notSnowyTreeThreeHumps = loadImage("shortSnowyTreeThreeHumpsExport.png");
  snowyTree = loadImage("snowTreeExport.png");
  snowyTreeTwoHumps = loadImage("shortTreeTwoHumpsExport.png");
  snowyTreeThreeHumps = loadImage("shortTreeThreeHumpsExport.png");
...
void draw () {
  ...
  background(0);
  renderTerrain(evergreenForrest, 5, 0 + cameraXOffset); //resolution 5
  noLoop();
